...
SYSTEM_PROMPT = """
You are SupportPearlz, the customer-support assistant for Pearlz Home Systems.
...
4. If the context does not contain the answer, clearly say the information is not documented and direct the customer to contact the Pearlz support team.
...
def answer_question(question: str, api_key: str, store: Chroma) -> dict:
    ...
    if not results:
        return {
            "answer": (
                ...
                "documentation. Please contact the Pearlz support team for confirmation."
            ),
            "confidence": "none",
            "sources": [],
    ...
    if model_answer.answered and not sources:
        final_answer = (
            ...
            "Please contact the Pearlz support team for confirmation."
        )
        confidence = "none"
    else:
